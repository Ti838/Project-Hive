...
const PHSidebar = (() => {
  ...
  const NAV = [
    ...
    { group: null,      href: '/saved',         key: 'saved',        icon: `<path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>`, label: 'Saved Items' },
    { group: null,      href: '/help',          key: 'help',         icon: `<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>`, label: 'Help Center' },
  ];
  ...
  function ensureUserPolishStyles() {
    ...
    link.rel = 'stylesheet';
    link.href = '/assets/css/user-polish.css?v=3';
  ...
  function buildProfileSheet() {
    ...
    sheet.style.cssText = 'position:fixed;bottom:0;left:0;right:0;z-index:99999;background:var(--sf,#fff);border-radius:20px 20px 0 0;transform:translateY(100%);transition:transform .3s cubic-bezier(.32,1.28,.58,1);padding:0;box-shadow:0 -8px 40px rgba(0,0,0,.18);max-height:85vh;overflow-y:auto;-webkit-overflow-scrolling:touch;';
    ...
    // Wire explicit navigation for profile sheet links to ensure they work reliably on mobile touch events
    sheet.querySelectorAll('.ph-ps-item').forEach(el => {
