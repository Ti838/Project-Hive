...
import { Sparkles, Code2, Video, MessageSquare, Plus, Hash, Mic, MicOff, Maximize2, Terminal } from 'lucide-react';
...
function PhoneOffIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
